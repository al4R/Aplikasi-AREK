...
import com.example.mobilearek.fragment.PesananFragment
...
class DetailPesananActivity : AppCompatActivity() {
    ...
    private fun sewa() {
        ...
        ApiConfig.instanceRetrofit.pesan(mobil.id,sewa).enqueue(object : retrofit2.Callback<ResponModel> {
            override fun onResponse(call: Call<ResponModel>, response: Response<ResponModel>) {
                ...
                if (respon != null) {
                    if (respon.success == 1){
                        ...
                        delete()
                        val intent = Intent (this@DetailPesananActivity, PesananActivity::class.java)
        ...
        sp.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            ...
            override fun onItemSelected(
                ...
                if(position == 0){
                    ...
                    tv_noRek.visibility = View.VISIBLE
                    tvSpiner.text = "345792034621505"
                    ivBayar.setImageResource(R.drawable.bri)
                }else if (position == 5){
                    tv_noRek.visibility = View.VISIBLE
                    tvSpiner.text = "9000185237842"
