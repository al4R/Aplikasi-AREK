...
class DaftarActivity : AppCompatActivity() {
    ...
    fun daftar() {
        if (edit_nama.text.toString().isEmpty()) {
            ...
            edit_telepon.error = "Nomor telepon tidak boleh kosong"
            ...
            edit_password.error = "Kata sandi tidak boleh kosong"
            ...
            override fun onResponse(call: Call<ResponModel>, response: Response<ResponModel>) {
                ...
                if (respon != null) {
                    if (respon.success == 1){
                        ...
                        Toast.makeText(this@DaftarActivity, "Berhasil mendaftar ", Toast.LENGTH_SHORT).show()
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_NEW_TASK)
                        startActivity(intent)
                        finish()
                    }else{
